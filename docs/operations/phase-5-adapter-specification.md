...
UI Contract 0.3.0 has explicit import and migration outcomes and deterministic JSON
...
type AdapterManifest = {
  ...
  acceptsContractSchemaVersions: readonly ['0.3.0']
  mappings: Array<{
    rule:
      | {
          kind: 'decision'
...
- Adapter `0.1.0` accepts only Contract `0.3.0`. Future Contract versions are
...
- Preserve the current Contract 0.3.0 importer, catalog, schema, and outputs as inputs.
