...
export const contractCatalog: readonly ContractCatalogEntry[] = [
  ...
  decision('confirmation-scope', 'interaction-policy', 'interactionPolicy.confirmation.scope', 'destructive-only', 'Confirmation scope', 'Actions requiring confirmation.', [option('destructive-only', 'Destructive only', 'Only destructive actions.'), option('destructive-bulk-unsaved', 'Destructive, bulk, unsaved', 'Also bulk and unsaved changes.')]),
