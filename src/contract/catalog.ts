...
export const contractCatalog: readonly ContractCatalogEntry[] = [
  ...
  decision('tabs-treatment', 'component', 'componentPolicy.tabs.treatment', 'line-tabs', 'Tabs treatment', 'Visual treatment for a tablist and its related panel.', [option('line-tabs', 'Line tabs', 'Show a selected-tab line above its related panel.'), option('contained-tabs', 'Contained tabs', 'Attach the selected tab to an emphasized content panel.')]),
