...
export const contractCatalog: readonly ContractCatalogEntry[] = [
  ...
  decision('button-primary-emphasis', 'component', 'componentPolicy.button.primaryEmphasis', 'filled', 'Primary emphasis', 'Visible treatment for the primary action.', [option('filled', 'Filled', 'Filled with the primary color.'), option('filled-tonal', 'Filled tonal', 'Tonal action surface.'), option('outline', 'Outline', 'Colored text and border.')]),
  ...
  decision('radio-group-treatment', 'component', 'componentPolicy.radioGroup.treatment', 'visible-label-radio-group', 'Radio group', 'Visible group and option labels for a vertically scanned radio group.', [option('visible-label-radio-group', 'Visible-label radio group', 'Use a visible group label, paired option labels, vertical options, and a selected state that is not colour-only.')]),
