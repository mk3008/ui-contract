...
export const uiContractJsonSchema: Schema = {
  ...
  $id: 'https://ui-contract-editor.local/schema/ui-contract-0.4.0.json',
  title: 'UI Contract',
  type: 'object',
