...
const dependency = strictObject({ id: identifier, patternVersion: version })

export const compositionPatternJsonSchema: Schema = {
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  $id: 'https://ui-contract-editor.local/schema/composition-pattern-0.1.0.json',
  title: 'Composition Pattern Artifact', type: 'object',
  ...
  properties: {
    artifactKind: { const: 'composition-pattern' }, patternSchemaVersion: { const: artifactSchemaVersion }, id: identifier, patternVersion: version, title: text, purpose: text,
    appliesWhen: stringArray(), nonGoals: stringArray(), requires: coreRequirements, composes: strictObject({ compositionPatterns: { type: 'array', items: dependency } }),
